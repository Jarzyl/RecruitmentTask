...
const Form = () => {
  ...
  return (
    <div className='bg-slate-600 md:pb-20'>
        <Head>
            <title>Dishes</title>
            <meta name="description" content="Generated by create next app"/>
        </Head>

    <div className='ml-5 mr-5 items-center text-center justify-center h-screen'>
      <h1 className='mb-6 text-lg xl:text-xl text-blue-600 pt-12 font-bold'>Place your order!</h1>
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto p-4 bg-white rounded shadow-md">
      <div className="mb-4">
        ...
        />
        {errors.name && <span className='text-red-500'>You must fill in this field!</span>}
      </div>
      <div className="mb-4">
